...
module.exports = class BurgerOrder extends Order {
  ...
  handleInput(sInput) {
    ...
    switch (this.stateCur) {
      ...
      case OrderState.WELCOMING:
        ...
        aReturn.push("What would you like to order for today? "+sInput+"");
        aReturn.push("Menu: \n 1.Burger \n 2.Wrap");
        
        break;
      case OrderState.GREETING:
        aReturn.push("We are glad to have you here "+sInput+" !");
      case OrderState.MENU:
        if (sInput.toLocaleLowerCase() == "burger") {
          ...
          aReturn.push("We only offer Burger and Wrap as main Items!");
        }
        break;
      ...
      case OrderState.CHICKEN:
        if (sInput.toLocaleLowerCase() == "yes" || sInput.toLocaleLowerCase() == "no") {
          ...
          aReturn.push(`Thank-you ${this.sName} for your order of $${this.Price} `);
  ...
  renderForm(sTitle = "-1", sAmount = "-1") {
    ...
    const sClientID = process.env.SB_CLIENT_ID || 'AcT1t-cMcpeUEOTEp_SjA927WI-onXn-4gR20uoNn56n4VhzubvKA8fp5OTLYDOkynSNCQfZX0AA66Oc'
    return (`
      <!DOCTYPE html>
      ...
      <body>
        ...
        Thank you ${this.sName} for your ${this.ordermessage} order of $${this.nOrder} please pay using any of the following:
